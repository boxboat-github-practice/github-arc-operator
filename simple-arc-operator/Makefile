...
# example.com/simple-arc-operator-bundle:$VERSION and example.com/simple-arc-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/boxboat-github-practice/simple-arc-operator
